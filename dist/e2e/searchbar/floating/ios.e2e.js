describe('searchbar/floating: ios', function() {

it('should init', function() {
  browser.get('http://localhost:8876/dist/e2e/searchbar/floating/index.html?ionicplatform=ios&ionicanimate=false&snapshot=true');
});
