describe('nav/basic: android', function() {

it('should init', function() {
  browser.get('http://localhost:8876/dist/e2e/nav/basic/index.html?ionicplatform=android&ionicanimate=false&snapshot=true');
});
