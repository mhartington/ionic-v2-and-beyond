System.register("index", ["angular2/angular2", "ionic/ionic", "ionic/util"], function (_export) {
    ...
    var ElementRef, Directive, App, Content, dom, __decorate, __metadata, ParallaxEffect, IonicApp, _a, _b;
    ...
    return {
        ...
        execute: function () {
            ...
            }), __metadata('design:paramtypes', [typeof (_a = typeof Content !== 'undefined' && Content) === 'function' && _a || Object, typeof (_b = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _b || Object])], ParallaxEffect));
