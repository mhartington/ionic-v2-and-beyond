System.register("index", ["angular2/angular2", "ionic/ionic"], function (_export) {
    ...
    var Directive, ElementRef, App, NavController, IonicView, __decorate, __metadata, AppPage, ParallaxEffect, IonicApp, _a, _b;
    ...
    return {
        ...
        execute: function () {
            ...
            }), __metadata('design:paramtypes', [typeof (_a = typeof NavController !== 'undefined' && NavController) === 'function' && _a || Object])], AppPage);
            ...
            _export("ParallaxEffect", ParallaxEffect = __decorate([Directive({
                selector: '[parallax]',
                properties: ['parallax']
            }), __metadata('design:paramtypes', [typeof (_b = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _b || Object])], ParallaxEffect));
            /**
