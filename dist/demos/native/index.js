System.register("index", ["ionic/ionic", "pages/camera", "pages/battery", "pages/contacts", "pages/device", "pages/device-motion", "pages/device-orientation", "pages/dialogs", "pages/geolocation", "pages/statusbar", "pages/vibration"], function (_export) {
    ...
    var IonicApp, App, Events, CameraPage, BatteryPage, ContactsPage, DevicePage, DeviceMotionPage, DeviceOrientationPage, DialogsPage, GeolocationPage, StatusBarPage, VibrationPage, __decorate, __metadata, MyApp, _a, _b;
    ...
    return {
        ...
        execute: function () {
            ...
            }), __metadata('design:paramtypes', [typeof (_a = typeof IonicApp !== 'undefined' && IonicApp) === 'function' && _a || Object, typeof (_b = typeof Events !== 'undefined' && Events) === 'function' && _b || Object])], MyApp);
        }
    };
});