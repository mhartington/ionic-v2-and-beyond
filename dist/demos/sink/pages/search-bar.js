System.register("pages/search-bar", ["angular2/angular2", "angular2/forms", "ionic/ionic", "../sink-page"], function (_export) {
    ...
    var Component, FormBuilder, Validators, IonicApp, IonicView, SinkPage, __decorate, __metadata, SearchBarPage, _a, _b;
    ...
    return {
        ...
        execute: function () {
            ...
            }), __metadata('design:paramtypes', [typeof (_a = typeof IonicApp !== 'undefined' && IonicApp) === 'function' && _a || Object, typeof (_b = typeof FormBuilder !== 'undefined' && FormBuilder) === 'function' && _b || Object])], SearchBarPage));
        }
    };
});