System.register("index", ["angular2/angular2", "angular2/forms", "ionic/ionic", "./geo", "./weather", "./flickr"], function (_export) {
    ...
    var Component, View, NgIf, NgClass, ElementRef, FormBuilder, Validators, FORM_DIRECTIVES, App, IonicView, Modal, Geo, Weather, Flickr, __decorate, __metadata, SettingsModal, WEATHER_ICONS, WeatherIcon, CurrentTime, CurrentWeather, BackgroundCycler, WeatherApp, _a, _b, _c, _d;
    ...
    return {
        ...
        execute: function () {
            ...
            }), __metadata('design:paramtypes', [typeof (_a = typeof FormBuilder !== 'undefined' && FormBuilder) === 'function' && _a || Object])], SettingsModal));
            WEATHER_ICONS = {
            ...
            _export("CurrentWeather", CurrentWeather = __decorate([Component({
                ...
                directives: [NgIf]
            }), __metadata('design:paramtypes', [typeof (_b = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _b || Object])], CurrentWeather));
            ...
            }), __metadata('design:paramtypes', [typeof (_c = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _c || Object])], BackgroundCycler));
            ...
            }), __metadata('design:paramtypes', [typeof (_d = typeof Modal !== 'undefined' && Modal) === 'function' && _d || Object])], WeatherApp);
        }
    };
});