...
import { Component, Directive, Optional, ElementRef, TemplateRef, forwardRef, Inject } from 'angular2/angular2';
import { Ion } from '../ion';
...
export let Navbar = class extends ToolbarBase {
    constructor(app, viewCtrl, elementRef, config) {
...
Navbar = __decorate([
    ...
    __param(1, Optional()), 
    __metadata('design:paramtypes', [(typeof (_d = typeof IonicApp !== 'undefined' && IonicApp) === 'function' && _d) || Object, (typeof (_e = typeof ViewController !== 'undefined' && ViewController) === 'function' && _e) || Object, (typeof (_f = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _f) || Object, (typeof (_g = typeof IonicConfig !== 'undefined' && IonicConfig) === 'function' && _g) || Object])
], Navbar);
/*
...
NavbarTemplate = __decorate([
    ...
    __param(0, Optional()),
    __param(1, Optional()), 
    __metadata('design:paramtypes', [(typeof (_h = typeof ViewController !== 'undefined' && ViewController) === 'function' && _h) || Object, (typeof (_j = typeof TemplateRef !== 'undefined' && TemplateRef) === 'function' && _j) || Object])
], NavbarTemplate);
