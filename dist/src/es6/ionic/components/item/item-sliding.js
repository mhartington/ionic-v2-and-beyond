...
import { Component, Directive, ElementRef, Host, Optional, Renderer, NgZone } from 'angular2/angular2';
import { DragGesture } from 'ionic/gestures/drag-gesture';
import { Hammer } from 'ionic/gestures/hammer';
import { List } from 'ionic/components/list/list';
import { CSS, raf } from 'ionic/util/dom';
export let ItemSlidingOptionButton = class {
...
ItemSlidingOptionButton = __decorate([
    Directive({
...
ItemSliding = __decorate([
    ...
    __param(2, Optional()),
    __param(2, Host()), 
    __metadata('design:paramtypes', [(typeof (_b = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _b) || Object, (typeof (_c = typeof Renderer !== 'undefined' && Renderer) === 'function' && _c) || Object, (typeof (_d = typeof List !== 'undefined' && List) === 'function' && _d) || Object, (typeof (_e = typeof NgZone !== 'undefined' && NgZone) === 'function' && _e) || Object])
], ItemSliding);
